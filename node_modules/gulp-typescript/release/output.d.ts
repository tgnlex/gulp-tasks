...
import * as input from 'gulp-typescript/release/input';
import * as reporter from 'gulp-typescript/release/reporter';
import * as project from 'gulp-typescript/release/project';
